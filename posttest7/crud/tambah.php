...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO reviews (username, id_user, email, usia, produk, rating, review, foto) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $db_connect->prepare($query);
    $stmt->bind_param("sissssss", $username, $id_user, $email, $usia, $produk, $rating, $review, $nama_file);
...
<form action="tambah.php" method="POST" enctype="multipart/form-data">
    ...
    <button type="button" onclick="location.href='index.php'" class="buttonhapus">Kembali</button>
</form>
