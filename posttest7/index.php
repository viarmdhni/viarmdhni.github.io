    ...
    <nav>
        ...
        <ul class="login">
            <?php if(isset($_SESSION['id_user'])): ?>
                ...
                <?php else: ?>
                    <li><a href="user.php">Review Saya</a></li>
                <?php endif; ?>
                <li><a href="logout.php">Logout</a></li>
            <?php else: ?>
                <li><a href="#login" onclick="location.href='login.php'">Login</a></li>
                <li><a href="#signup" onclick="location.href='regis.php'">Sign Up</a></li>
            <?php endif; ?>
        </ul>
    </nav>
